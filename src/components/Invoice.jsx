import "./Invoice.css"; // Assuming you have a separate CSS file for the styles
...
import StateDropdown from "../data/StateDropdown";
...
const Invoice = () => {
  ...
  const invoiceDateInputRef = useRef(null); // Reference for Invoice Date input
  const dueDateInputRef = useRef(null); // Reference for Due Date input
  const calendarIconRefInvoice = useRef(null); // Reference for Invoice calendar icon
  const calendarIconRefDue = useRef(null); // Reference for Due Date calendar icon
  ...
  return (
    <>
      <div className="flex justify-between items-center ">
        ...
        <div className="invoice p-4" ref={targetRef}>
          <div className="flex mb-2">
            ...
            <div className="flex items-center w-[8px] h-[106.2px] ml-3">
              <input
                ...
                className="w-[350px] mx-[27px] mb-[2px]  p-[4px_12px_4px_3px] 
